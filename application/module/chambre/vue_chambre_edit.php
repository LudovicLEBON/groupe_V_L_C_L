       <form method="post" action="<?= hlien("chambre", "save") ?>">
           ...
           <div class='form-group'>
               <input id='cha_jacuzzi' name='cha_jacuzzi' type='checkbox' size='50' <?= $check = $cha_jacuzzi == 1 ? 'checked' : '' ?> />
               <label for='cha_jacuzzi'>Jacuzzi</label>
           </div>
           <div class='form-group'>
               <input id='cha_balcon' name='cha_balcon' type='checkbox' size='50' <?= $check = $cha_balcon == 1 ? 'checked' : '' ?> />
               <label for='cha_balcon'>Balcon</label>
           </div>
           <div class='form-group'>
               <input id='cha_wifi' name='cha_wifi' type='checkbox' size='50' <?= $check = $cha_wifi == 1 ? 'checked' : '' ?> />
               <label for='cha_wifi'>Wifi</label>
           </div>
           <div class='form-group'>
               <input id='cha_minibar' name='cha_minibar' type='checkbox' size='50' <?= $check = $cha_minibar == 1 ? 'checked' : '' ?> />
               <label for='cha_minibar'>Minibar</label>
           </div>
           <div class='form-group'>
               <input id='cha_coffre' name='cha_coffre' type='checkbox' size='50' <?= $check = $cha_coffre == 1 ? 'checked' : '' ?> />
               <label for='cha_coffre'>Coffre</label>
           </div>
           <div class='form-group'>
               <input id='cha_vue' name='cha_vue' type='checkbox' size='50' <?= $check = $cha_vue == 1 ? 'checked' : '' ?> />
